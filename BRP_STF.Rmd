...
include_graphics(file.path(paste0("model/stf/",ESC_model,"/fig_forecast.png")))
```
...
```{r}
library(kableExtra)
load(paste0("model/stf/",ESC_model,"/STFSummary.Rdata"))
...
table<-round(dfSTFSummary[,c(15,7,9,10,3,5,13,14,11)],3)
names(table)<-c("Mult","F","Rec_2024","Rec_2025","SSB_2024","SSB_2025","pBlim_2024","pBlim_2025","Catch_2024")

kable(table, format = "latex", booktabs = TRUE, longtable = TRUE, digits = 1, align = 'c',
      caption = "\\label{tb:stf} Management options  from the stochastic short-term forecasts at fishing mortalities levels used for the different catch scenario options in the advice") %>%
